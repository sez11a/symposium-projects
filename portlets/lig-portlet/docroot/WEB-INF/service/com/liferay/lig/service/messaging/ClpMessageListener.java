...
package com.liferay.lig.service.messaging;

import com.liferay.lig.service.ClpSerializer;
import com.liferay.lig.service.InsultLocalServiceUtil;
import com.liferay.lig.service.InsultServiceUtil;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			InsultLocalServiceUtil.clearService();

			InsultServiceUtil.clearService();
		}
	}
